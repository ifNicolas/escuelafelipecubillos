  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <a href="<?php echo base_url('contacto')?>" class="btn-get-started container-fluid"><strong>Matriculate</strong> </a>
    </div>
  </section><!-- End Hero -->
     ...
     <div class="modal "  tabindex="-1" id="ventana_modal">
      <div class="modal-dialog" >
        ...
        <div class="modal-header">
          <h5 class="titulo-modal">Nuestra Escuela Felipe Cubillos</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body"  >
          <iframe class="content-fluid" width="100%" height="315" src="https://www.youtube.com/embed/WrTz_T8el1E" title="Video de youtube" frameborder="0" allow="accelerometer;  clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>  
        </div>
      </div>
      </div>
