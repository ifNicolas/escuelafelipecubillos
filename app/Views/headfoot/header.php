        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span><i class="fa-solid fa-cloud-arrow-down nav_url">&nbsp;</i><p class="fuenteNav"> Otros</p></span> <i class=" order-lg-0"></i></a>
            <ul class="container-fluid">
              <li class="container"><a href="principal/descarga"><strong> <i class="fa-solid fa-file-circle-plus">&nbsp;</i>DESCARGA</strong></a></li>
              <br>
              <br>

              <li class="container"><a href="principal/login"><strong> <i class="fa-solid fa-house">&nbsp;</i>Iniciar Sesion</strong></a></li>
              <br>
            </ul>
          </li>

          <li class="container-fluid"><a href="principal/inicio"><i class="fa-solid fa-house">&nbsp;</i><p class="fuenteNav"> Inicio</p></a></li>
          <li class="container-fluid"><a  href="principal/profesores"><i class="fa-solid fa-graduation-cap">&nbsp;</i><p class="fuenteNav"> Profesores</p></a></li>
          <li class="container-fluid"><a href="principal/proyectos"><i class="fa-solid fa-person-digging">&nbsp;</i><p class="fuenteNav"> Proyectos</p></a></li>
          <li class="container-fluid"><a  href="principal/contacto"><i class="fa-solid fa-message">&nbsp;</i><p class="fuenteNav"> Contacto</p></a></li>
